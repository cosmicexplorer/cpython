...
static void
gc_pdmp_header_init(struct dump_header* header) {
...
static PyObject *
gc_pdmp_dump_impl(struct dump_context* dump_context) {
  return NULL;
}
...
static PyObject *
gc_pdmp_dump(PyObject *Py_UNUSED(module), PyObject *obj, PyObject *fd_obj)
/*[clinic end generated code: output=e1516ac119a918ed input=201d0c58f69ae390]*/
{
  int fd;
  ...
  if (fd == -1) {
    PyErr_SetString(PyExc_TypeError, "provided fd did not point to an existing file descriptor");
    goto error;
  }
...
static int
gc_pdmp_map(int fd, pdmp * pdmp) {
  struct _Py_stat_struct status;
  if (_Py_fstat(fd, &status)) {
    goto error;
  }

  pdmp->mapped_memory_length = status.st_size;
  pdmp->mapped_memory_region = mmap(NULL, pdmp->mapped_memory_length, PROT_READ, MAP_PRIVATE, fd, 0);
  ...
  pdmp->entries = (struct dump_reloc_entry*)(pdmp->num_entries + sizeof(size_t));
  pdmp->data = (void*)(pdmp->entries + ((*pdmp->num_entries) * sizeof(struct dump_reloc_entry*)));
...
static void
gc_pdmp_unmap(pdmp* pdmp) {
  munmap(pdmp->mapped_memory_region, pdmp->mapped_memory_length);
}

static PyObject *
pdmp_new(PyTypeObject *type, PyObject *args, PyObject *kwds)
{
...
static int
pdmp_init(pdmp *self, PyObject *args, PyObject *kwds) {
...
PyDoc_STRVAR(pdmp_fileno_doc, "The file descriptor associated with the pdmp object");

static PyObject*
pdmp_fileno(pdmp* self, PyObject* Py_UNUSED(ignored)) {
...
static PyObject*
pdmp_enter(pdmp* pdmp, PyObject* Py_UNUSED(ignored)) {
  return Py_None;
}

static PyObject*
pdmp_exit(pdmp* pdmp, PyObject* Py_UNUSED(ignored)) {
  return Py_None;
}
...
static PyMethodDef pdmp_methods[] = {
    ...
    {"__exit__", (PyCFunction)pdmp_exit, METH_NOARGS, pdmp_exit_doc},
    {NULL, NULL} /* sentinel */
};
...
static PyObject *
gc_pdmp_load(PyObject *Py_UNUSED(module), PyObject *filename)
/*[clinic end generated code: output=e1516ac119a918ed input=201d0c58f69ae390]*/
{
  int fd;
  pdmp pdmp;
