...
static PyObject *
gc_pdmp_dump(PyObject *module, PyObject *obj, PyObject *fd);

static PyObject *
gc_pdmp_load(PyObject *module, PyObject *fd);
...
"\n"
"pdmp_dump() -- Dump a portable representation of some portion of the GC state to disk.\n"
"pdmp_load() -- Load a portable representation of some portion of the GC state from disk.\n");
...
static PyMethodDef GcMethods[] = {
    ...
    GC_PDMP_DUMP_METHODDEF
    GC_PDMP_LOAD_METHODDEF
    {NULL,      NULL}           /* Sentinel */
};
...
struct dump_header {
  ...
  /* "Relocation" table we (ab)use to hold information abouat the
     location and type of each python object in the dump. */
...
static PyObject *
gc_pdmp_dump(__attribute__((unused)) PyObject *module, PyObject *obj, PyObject *fd_obj)
/*[clinic end generated code: output=e1516ac119a918ed input=201d0c58f69ae390]*/
{
  int fd;
  PyObject* dump_filename;
  ...
  return gc_pdmp_dump_impl(&dump_context);
}
